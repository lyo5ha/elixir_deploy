...
1.  [Установка elixir, erlang и node.js](#orgc6b2068)
    1.  [Mенеджер версий asdf](#orgba04916)
    2.  [Установка Эрланга](#orgf32f415)
    3.  [Установка Эликсира](#orge2e553b)
    4.  [Установка Node.js](#orgeda092c)
    5.  [Установка Phoenix (для разработки на локальной машине).](#orgc5db44e)
2.  [Устанавливаем NGNIX, конфигурация](#org2098c90)
    1.  [Установка, запуск Ngnix](#org253027f)
    2.  [Конфигурация Ngnix](#orgaff216d)
3.  [SSL-сертификат](#org0317fc1)
4.  [Postgresql](#org3b4ae02)
5.  [Конфигурация проекта](#org99f7a10)
    1.  [config/prod.exs](#orgcafe3e7)
    2.  [Хранение prod.secret.exs](#orgcac1296)
    3.  [Distillery, Edeliver](#orgd056d7c)
        1.  [Добавляем в зависимости в `mix.exs`](#orgbd2afe6)
        2.  [Создаем релиз(конфиг edeliver)](#orgc5d0611)
6.  [Управление релизами](#orgc613049)
    1.  [Деплой, администрирование релизов](#orgd47c14a)
        1.  [Команды деплоя](#orgf192fb9)
        2.  [Логи](#org7207c6f)
        3.  [Компилирование ассетов при деплое](#org96fc746)
    2.  [.edeliver/config - финальный вид](#orgc8d5d0b)
7.  [Возможные проблемы](#org14cf031)
8.  [Деплоим второе приложение на тот же сервер](#org72db775)
    1.  [Изменить конфиг еделивера.](#org17d3abb)
    2.  [Конфигурация ngnix](#orgbf5bc08)
        1.  [Создаем еще один серверный блок](#orgca78719)
